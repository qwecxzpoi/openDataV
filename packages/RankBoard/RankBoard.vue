...
import { useProp, useData } from '@open-data-v/core'
import type { BaseComponent, DataType } from '@open-data-v/core'
import type { RequestResponse } from '@open-data-v/core/types'
